...
public class Dash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        content.setLayout(jPanel1Layout);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            java.util.ArrayList<entity.Barang>a=new entity.dao.DAOBarang(d).getData();
            int x=0;
            for(entity.Barang b:a){
                java.awt.GridBagConstraints g=new java.awt.GridBagConstraints();
                g.gridx=0;
                g.gridy=x*2;
                x++;
                ui.UIBarang ub=new ui.UIBarang(b);
                ub.setVisible(true);
                content.add(ub, g);
            }d.close();
